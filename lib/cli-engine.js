 ...
 * @param {Object} configHelper The configuration options for ESLint.
 * @param {string=} filePath The path to a file to load the config from.
 * @returns {Result} The results for linting on this text.
 * @private
 */
function processText(text, configHelper, filePath) {
    ...
    config = configHelper.getConfig(filePath);
    loadPlugins(config.plugins);
    messages = eslint.verify(text, config, filePath || "<text>");
...
CLIEngine.prototype = {
     ...
     * @param {string=} filePath The path to a file used to retrieve a config object.
     * @returns {Object} The results for the linting.
     */
    executeOnText: function(text, filePath) {

        var configHelper = new Config(this.options),
            results = [];

        results.push(processText(text, configHelper, filePath));
